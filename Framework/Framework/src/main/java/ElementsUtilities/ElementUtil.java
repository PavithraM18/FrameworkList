...
private WebDriver driver;
	...
	public void urlSelect(By locator) {
		WebElement element = getElement(locator);
		element.click();
	...
	public void doActionsSendKeys1(By locator, String value) {
		Actions act = new Actions(driver);
		act.sendKeys(getElement(locator), value,Keys.ENTER).build().perform();
	}
